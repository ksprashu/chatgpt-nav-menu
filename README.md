...
4. Open a ChatGPT conversation and click the extension icon in Chrome to toggle the sidebar.

## How it works
- The content script reads all messages authored by you (`data-message-author-role="user"`).
- The content script injects a sidebar into the ChatGPT page and keeps it in sync with your prompts.
